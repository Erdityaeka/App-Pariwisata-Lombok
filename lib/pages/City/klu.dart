...
import 'package:pariwisatalom/model/klu_place.dart';
import 'package:pariwisatalom/pages/home/detail.dart';

class KLUScreen extends StatelessWidget {
  const KLUScreen({super.key});
...
class Detailweb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      crossAxisSpacing: 10,
      mainAxisSpacing: 10,
      children: parisKluPlace.map((place) {
        return InkWell(
              onTap: () {
                Navigator.push(
                  context,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.builder(
          itemCount: parisKluPlace.length,
          itemBuilder: (context, index) {
            final place = parisKluPlace[index];
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
