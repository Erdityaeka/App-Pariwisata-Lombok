...
import 'package:pariwisatalom/model/lotim_place.dart';
import 'package:pariwisatalom/pages/home/detail.dart';

class LotimScreen extends StatelessWidget {
  const LotimScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.builder(
          itemCount: parislotim.length,
          itemBuilder: (context, index) {
            final place = parislotim[index];
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
