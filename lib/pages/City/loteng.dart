...
import 'package:pariwisatalom/model/loteng_place.dart';
import 'package:pariwisatalom/pages/home/detail.dart';

class LotengScreen extends StatelessWidget {
  const LotengScreen({super.key});
...
class Detailweb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      crossAxisSpacing: 10,
      mainAxisSpacing: 10,
      children: parisloteng.map((place) {
        return InkWell(
              onTap: () {
                Navigator.push(
                  context,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.builder(
          itemCount: parisloteng.length,
          itemBuilder: (context, index) {
            final place = parisloteng[index];
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
